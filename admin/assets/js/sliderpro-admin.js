...
(function( $ ) {
	...
	var MainImageEditor = {
		...
		init: function() {
			...
			$( window ).on( 'keydown.mainImageEditor', function( event ) {
				if (event.key === 'Escape') {
					event.preventDefault();
					that.save();
					that.close();
		...
		close: function() {
			...
			$( window ).off( 'keydown.mainImageEditor' );
	...
	var ThumbnailEditor = {
		...
		init: function() {
			...
			$( window ).on( 'keydown.thumbnailEditor', function( event ) {
				if (event.key === 'Escape') {
					event.preventDefault();
					that.save();
					that.close();
		...
		close: function() {
			...
			$( window ).off( 'keydown.thumbnailEditor' );
	...
	var CaptionEditor = {
		...
		init: function() {
			...
			$( window ).on( 'keydown.captionEditor', function( event ) {
				if (event.key === 'Escape') {
					event.preventDefault();
					that.save();
					that.close();
		...
		close: function() {
			...
			$( window ).off( 'keydown.captionEditor' );
	...
	var PreviewWindow = {
		...
		init: function() {
			...
			$( window ).on( 'keydown.preview', function( event ) {
				if (event.key === 'Escape') {
					event.preventDefault();
					that.close();
				}
