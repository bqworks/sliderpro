...
= 4.8.16 =
* validate the breakpoint width as numeric before rendering it in the inline script

= 4.8.15 =
* sanitize the slider id attribute and escape it when rendering the inline script

= 4.8.14 =
* add nonce verification when previewing the slider
...
= 4.8.9 =
* improve slide content settings loading in admin
